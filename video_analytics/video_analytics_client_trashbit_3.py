...
if __name__ == "__main__":
  send_process = Process(target=send_frames,args=(client_socket,send_frame_size))
  receive_process = Process(target=receive_frames,args=(client_socket, 8192-20))
...
#receive_thread = threading.Thread(target=receive_frames,args=(client_socket, 8192-20))
